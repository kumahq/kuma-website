...
This is done through [transparent proxying](/docs/{{ page.version }}/production/networking/transparent-proxying),
...
Kuma CNI can be leveraged in the two installation methods for Kubernetes: using [`kumactl`](/docs/{{ page.version }}/production/install/kubernetes) and with [Helm](/docs/{{ page.version }}/production/install/helm).
...
1. Follow the instructions in [OpenShift 3.11 installation](/docs/{{ page.version }}/production/install/openshift)
