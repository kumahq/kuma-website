...
To send a request to any zone, you can [use the generated `kuma.io/service`](../explore/dpp-on-kubernetes.md#tag-generation) and [{{ site.mesh_product_name }} DNS](../networking/dns.md#dns):
