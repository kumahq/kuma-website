---
title: Authenticate with the data plane proxy
---
...
Service Account Token is not bound to a mesh, see [data plane proxy membership](/docs/{{ page.version }}/security/do-membership) how to restrict which Pods can join a mesh.
