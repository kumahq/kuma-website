...
Service Account Token is not bound to a mesh, see [data plane proxy membership](/docs/{{ page.version }}/production/security/dp-membership) how to restrict which Pods can join a mesh.
