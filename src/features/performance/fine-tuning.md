...
Follow the [transparent proxying](/docs/{{ page.version }}/production/networking/transparent-proxying) docs on how to configure it.
...
For systems with high traffic, keeping old endpoints for such a long time (5s) may not be acceptable. To solve this, you can use passive or active [health checks](/docs/{{ page.version }}/features/health-check/health-check-policy) provided by Kuma.
