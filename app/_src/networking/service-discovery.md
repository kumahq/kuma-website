...
* On Universal by looking at the inbound listeners that have been configured in the [`inbound` property](/docs/{{ page.version }}/dp-config/dpp-on-universal#dataplane-configuration) of the data-plane specification.
