...
Status is managed by {{site.mesh_product_name}} and visible only in zone control planes (not global):

| Field | Description |
|-------|-------------|
| `addresses` | hostnames generated by [HostnameGenerators](/docs/{{ page.release }}/networking/hostnamegenerator/). |
