...
* [Non-mesh traffic](/docs/{{ page.release }}/networking/{% if_version gte:2.9.x %}transparent-proxy/{% endif_version %}non-mesh-traffic), to setup if `passthrough` mode should be used for the non-mesh traffic.
