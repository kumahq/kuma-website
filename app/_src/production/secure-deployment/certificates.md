...
{% endtabs %}
  ...
  If you recieve an error like the following, make sure you are using a supported certificate type and that the certificate doesn't contain incomplete or corrupted data:
  ```sh
