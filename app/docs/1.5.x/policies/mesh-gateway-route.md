...
`MeshGatewayRoute` is a policy used to configure [Kuma's builtin gateway](/docs/{{ page.release }}/documentation/gateway#builtin).
...
The reference doc contains all options on [`MeshGatewayRoute`](/docs/{{ page.release }}/generated/policies/mesh-gateway-route).
