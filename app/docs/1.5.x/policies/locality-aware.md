...
In a [multi-zone deployment](/docs/{{ page.release }}/documentation/deployments/), locality-aware load balancing
...
The configuration can be applied with `kumactl apply -f [..]` or via the [HTTP API](/docs/{{ page.release }}/documentation/http-api).
{% endtab %}
{% endtabs %}
