...
{% tabs sample-generation useUrlFragment=false %}
{% tab sample-generation openssl %}
...
{% tabs cert-rotation useUrlFragment=false %}
{% tab cert-rotation kumactl %}
