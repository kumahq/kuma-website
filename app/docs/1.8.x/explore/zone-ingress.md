...
To implement cross-zone communication when Kuma is deployed in a [multi-zone](/docs/{{ page.release }}/deployments/multi-zone) mode, there is a new proxy type `ZoneIngress`.
