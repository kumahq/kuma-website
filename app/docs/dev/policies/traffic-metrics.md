...
* Because metrics are part of the mesh configuration, Kuma exposes an api called the monitoring assigment service (MADS) which exposes every proxy in the mesh.
