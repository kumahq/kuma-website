...
More about [Protocol support in Kuma](/docs/{{ page.release }}/policies/protocol-support-in-kuma).
...
{% tabs general-purpose useUrlFragment=false %}
{% tab general-purpose Kubernetes %}
```yaml
