...
As explained in the [Overview](/docs/{{ page.release }}/documentation/introduction), when {{site.mesh_product_name}} (`kuma-cp`) is up and running it needs to store its state somewhere.
