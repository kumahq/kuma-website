...
The usage of {{site.mesh_product_name}} DNS is only relevant when [transparent proxying](/docs/{{ page.release }}/networking/transparent-proxying) is used.
...
- The mode can safely be used with the [{{site.mesh_product_name}} CNI plugin](/docs/{{ page.release }}/networking/cni).
