...
Available origins:
* `admin` - resources generated for exposing parts of Admin API. 
* `direct-access` - resources generated for Direct Access functionality.
* `dns` - resources generated for builtin DNS functionality.
...
* `probe` - resources generated for service probes on Kubernetes.
* `prometheus` - resources generated when Prometheus metrics are enabled.
* `tracing` - resources generated for tracing.
