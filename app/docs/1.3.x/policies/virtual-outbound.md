...
- Either [data plane proxy DNS](/docs/{{ page.release }}/networking/dns/#data-plane-proxy-dns), or else the value of `conf.host` must end with the value of `dns_server.domain` (default value `.mesh`).
