...
{% tabs traffic-route-example useUrlFragment=false %}
{% tab traffic-route-example Kubernetes %}
```yaml
apiVersion: kuma.io/v1alpha1
kind: TrafficRoute
mesh: default
...
{% tab traffic-route-example Universal %}
```yaml
type: TrafficRoute
name: full-example
mesh: default
...
{% tabs traffic-split-example useUrlFragment=false %}
{% tab traffic-split-example Kubernetes %}
```yaml
apiVersion: kuma.io/v1alpha1
kind: TrafficRoute
mesh: default
...
{% tab traffic-split-example Universal %}
```yaml
type: TrafficRoute
name: api-split
mesh: default
...
{% tabs traffic-rerouting-example useUrlFragment=false %}
{% tab traffic-rerouting-example Kubernetes %}
```yaml
apiVersion: kuma.io/v1alpha1
kind: TrafficRoute
mesh: default
...
{% tab traffic-rerouting-example Universal %}
```yaml
type: TrafficRoute
name: http-reroute
mesh: default
