...
See [Data plane proxy authentication](/docs/{{ page.release }}/security/dp-auth/) and [Zone Ingress authentication](/docs/{{ page.release }}/security/zone-ingress-auth).
...
{% tabs configure-global-control-plane useUrlFragment=false %}
...
{% endtab %}
{% tab configure-global-control-plane Universal %}
Point to the certificate and the key. 
```sh
