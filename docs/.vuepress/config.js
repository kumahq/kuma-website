      ...
      return {
        ...
        generated() {
          ...
          const redirects = [
            ...
            `/sidecar-injection /docs/${versions.latestMinor}/reference/kubernetes-annotations/#labels`,
            `/mesh /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-mesh`,
            `/sidecar-injection /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-sidecar-injection-2`,
            `/gateway /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-gateway`,
            `/ingress /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-ingress`,
            `/ingress-public-address /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-ingress-public-address`,
            `/ingress-public-port /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-ingress-public-port`,
            `/direct-access-services /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-direct-access-services`,
            `/virtual-probes /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-virtual-probes`,
            `/virtual-probes-port /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-virtual-probes-port`,
            `/sidecar-env-vars /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-sidecar-env-vars`,
            `/container-patches /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-container-patches`,
            `prometheus.metrics.kuma.io/port /docs/${versions.latestMinor}/reference/kubernetes-annotations/#prometheus-metrics-kuma-io-port`,
            `prometheus.metrics.kuma.io/path /docs/${versions.latestMinor}/reference/kubernetes-annotations/#prometheus-metrics-kuma-io-path`,
            `/builtindns /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-builtindns`,
            `/builtindnsport /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-builtindnsport`,
            `/ignore /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-ignore`,
            `traffic.kuma.io/exclude-inbound-ports /docs/${versions.latestMinor}/reference/kubernetes-annotations/#traffic-kuma-io-exclude-inbound-ports`,
            `traffic.kuma.io/exclude-outbound-ports /docs/${versions.latestMinor}/reference/kubernetes-annotations/#traffic-kuma-io-exclude-outbound-ports`,
            `/transparent-proxying-experimental-engine /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-transparent-proxying-experimental-engine`,
            `/envoy-admin-port /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-envoy-admin-port`,
            `/service-account-token-volume /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-service-account-token-volume`,
            `/transparent-proxying-reachable-services /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-transparent-proxying-reachable-services`,
            `prometheus.metrics.kuma.io/aggregate-<name>-enabled /docs/${versions.latestMinor}/reference/kubernetes-annotations/#prometheus-metrics-kuma-io-aggregate-name-enabled`,
            `prometheus.metrics.kuma.io/aggregate-<name>-path /docs/${versions.latestMinor}/reference/kubernetes-annotations/#prometheus-metrics-kuma-io-aggregate-name-path`,
            `prometheus.metrics.kuma.io/aggregate-<name>-port /docs/${versions.latestMinor}/reference/kubernetes-annotations/#prometheus-metrics-kuma-io-aggregate-name-port`,
            `/transparent-proxying-inbound-v6-port /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-transparent-proxying-inbound-v6-port`,
            `/sidecar-drain-time /docs/${versions.latestMinor}/reference/kubernetes-annotations/#kuma-io-sidecar-drain-time`,
