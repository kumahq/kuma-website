...
::: tip
Kuma also provides [Helm charts](/docs/1.1.2/installation/helm/) that we can use instead of this distribution.
:::
...
Once downloaded, you will find the contents of Kuma in the `kuma-` folder. In this folder, you will find - among other files - the `bin` directory that stores the executables for Kuma, including the CLI client [`kumactl`](/docs/1.1.2/documentation/cli/#kumactl).
