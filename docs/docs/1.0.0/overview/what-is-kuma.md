...
* [Standalone Deployment](/docs/1.0.0/documentation/deployments/#standalone-mode) with one control plane being in charge of multiple data plane proxies.
* [Multi-Zone Deployment](/docs/1.0.0/documentation/deployments/#multi-zone-mode) with a global control plane and remote control planes for each underlying cluster.
