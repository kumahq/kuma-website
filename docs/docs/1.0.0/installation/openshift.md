...
* [macOS](https://kong.bintray.com/kuma/kuma-1.0.0-darwin-amd64.tar.gz) or `brew install kumactl`
...
Once downloaded, you will find the contents of Kuma in the `kuma-1.0.0` folder. In this folder, you will find - among other files - the `bin` directory that stores the executables for Kuma, including the CLI client [`kumactl`](/docs/1.0.0/documentation/cli/#kumactl).
