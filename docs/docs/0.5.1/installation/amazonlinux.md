...
:::tip
If you wish to use Kuma on Amazon EKS please follow the [Kubernetes instructions](/docs/0.5.1/installation/kubernetes/) instead.
:::
...
or you can [download](https://kong.bintray.com/kuma/kuma-0.5.1-centos-amd64.tar.gz) the distribution manually.
