...
::: tip
This information has been documented for clarity, but when following the [installation instructions](/install/0.6.0) these settings will be automatically configured.
:::
