...
::: warning
Some feature flags may not provide backward compatibility, when this is the case it is clearly documented in [the control-plane configuration](../generated/kuma-cp.md) and will be part of the `experimental` section.
