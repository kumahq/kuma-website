...
::: tip
The official Docker images are used by default in the [Kubernetes](/docs/0.7.1/installation/kubernetes/) and [OpenShift](/docs/0.7.1/installation/openshift/) distributions.
:::
...
* **kuma-cp**: at `kong-docker-kuma-docker.bintray.io/kuma-cp:0.7.1`
* **kuma-dp**: at `kong-docker-kuma-docker.bintray.io/kuma-dp:0.7.1`
* **kumactl**: at `kong-docker-kuma-docker.bintray.io/kumactl:0.7.1`
* **kuma-prometheus-sd**: at `kong-docker-kuma-docker.bintray.io/kuma-prometheus-sd:0.7.1`
...
$ docker run \
    --net="host" \
    kong-docker-kuma-docker.bintray.io/kumactl:0.7.1 kumactl get meshes
...
mtls:
  ...
  kong-docker-kuma-docker.bintray.io/kumactl:0.7.1 kumactl apply -f -
```
...
* [macOS](https://kong.bintray.com/kuma/kuma-0.7.1-darwin-amd64.tar.gz)
...
You will then find the `kumactl` executable in the `kuma-0.7.1/bin` folder.
...
In order to start using Kuma, it's time to check out the [quickstart guide for Universal](/docs/0.7.1/quickstart/universal/) deployments. If you are using Docker you may also be interested in checking out the [Kubernetes quickstart](/docs/0.7.1/quickstart/kubernetes/) as well.
