...
or you can [download](https://kong.bintray.com/kuma/kuma-0.7.0-debian-amd64.tar.gz) the distribution manually.
...
This example will run Kuma in `standalone` mode for a "flat" deployment, but there are more advanced [deployment modes](/docs0.7.0/documentation/deployments/).
