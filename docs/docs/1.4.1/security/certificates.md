...
- Security between our services, via the [mTLS policy](/docs/1.4.1/policies/mutual-tls/).
...
:::tip
This section is not to be confused with the [mTLS policy](/docs/1.4.1/policies/mutual-tls/) that we can apply to a [Mesh](/docs/1.4.1/policies/mesh/) to secure service-to-service traffic.
:::
