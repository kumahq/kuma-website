...
::: tip
This information has been documented for clarity, but when following the [installation instructions](/install/1.0.1) these settings will be automatically configured.
:::
