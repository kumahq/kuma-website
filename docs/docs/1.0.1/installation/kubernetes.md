...
::: tip
Kuma also provides [Helm charts](/docs/1.0.1/installation/helm/) that we can use instead of this distribution.
:::
...
* [macOS](https://kong.bintray.com/kuma/kuma-1.0.1-darwin-amd64.tar.gz) or run `brew install kumactl`
...
In order to start using Kuma, it's time to check out the [quickstart guide for Kubernetes](/docs/1.0.1/quickstart/kubernetes/) deployments.
