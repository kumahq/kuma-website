...
Unlike other control planes, Kuma is easy to use. Anybody - from any team - can implement Kuma in [three simple steps](/install/0.7.2) across both traditional monolithic applications and modern microservices.
