...
* `kuma.io/zone`: Identifies the zone name in a [multi-zone deployment](/docs/1.0.2/documentation/deployments/). This tag is automatically created and cannot be overwritten.
