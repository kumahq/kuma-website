...
* Retrieve the state of Kuma and the configured [policies](../../policies) in every environment.
...
* `kumactl generate dataplane-token`: used to generate [Dataplane Token](../security/#dataplane-token).
