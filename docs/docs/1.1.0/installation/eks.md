...
::: tip
Kuma also provides [Helm charts](/docs/1.1.0/installation/helm/) that we can use instead of this distribution.
:::
...
* [macOS](https://kong.bintray.com/kuma/kuma-1.1.0-darwin-amd64.tar.gz) or run `brew install kumactl`
