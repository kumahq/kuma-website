...
::: tip
The official Docker images are used by default in the [Kubernetes](/docs/1.0.8/installation/kubernetes/) and [OpenShift](/docs/1.0.8/installation/openshift/) distributions.
:::
...
* **kuma-cp**: at `kong-docker-kuma-docker.bintray.io/kuma-cp:1.0.8`
* **kuma-dp**: at `kong-docker-kuma-docker.bintray.io/kuma-dp:1.0.8`
* **kumactl**: at `kong-docker-kuma-docker.bintray.io/kumactl:1.0.8`
* **kuma-prometheus-sd**: at `kong-docker-kuma-docker.bintray.io/kuma-prometheus-sd:1.0.8`
...
$ docker run \
    -p 5681:5681 \
    kong-docker-kuma-docker.bintray.io/kuma-cp:1.0.8 run
```
...
* [macOS](https://kong.bintray.com/kuma/kuma-1.0.8-darwin-amd64.tar.gz)
...
You will then find the `kumactl` executable in the `kuma-1.0.8/bin` folder.
