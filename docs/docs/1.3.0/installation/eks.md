...
::: tip
Kuma also provides [Helm charts](/docs/1.3.0/installation/helm/) that we can use instead of this distribution.
:::
...
* [macOS](https://download.konghq.com/mesh-alpine/kuma-1.3.0-darwin-amd64.tar.gz) or run `brew install kumactl`
...
In order to start using Kuma, it's time to check out the [quickstart guide for Kubernetes](/docs/1.3.0/quickstart/kubernetes/) deployments.
