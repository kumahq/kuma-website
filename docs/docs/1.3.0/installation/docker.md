...
::: tip
The official Docker images are used by default in the [Kubernetes](/docs/1.3.0/installation/kubernetes/) and [OpenShift](/docs/1.3.0/installation/openshift/) distributions.
:::
...
* **kuma-cp**: at `docker.io/kumahq/kuma-cp:1.3.0`
* **kuma-dp**: at `docker.io/kumahq/kuma-dp:1.3.0`
* **kumactl**: at `docker.io/kumahq/kumactl:1.3.0`
* **kuma-prometheus-sd**: at `docker.io/kumahq/kuma-prometheus-sd:1.3.0`
...
docker run \
    -p 5681:5681 \
    docker.io/kumahq/kuma-cp:1.3.0 run
```
...
* [CentOS](https://download.konghq.com/mesh-alpine/kuma-1.3.0-centos-amd64.tar.gz)
* [RedHat](https://download.konghq.com/mesh-alpine/kuma-1.3.0-rhel-amd64.tar.gz)
* [Debian](https://download.konghq.com/mesh-alpine/kuma-1.3.0-debian-amd64.tar.gz)
* [Ubuntu](https://download.konghq.com/mesh-alpine/kuma-1.3.0-ubuntu-amd64.tar.gz)
* [macOS](https://download.konghq.com/mesh-alpine/kuma-1.3.0-darwin-amd64.tar.gz)
