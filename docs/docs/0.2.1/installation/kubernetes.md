...
* [CentOS](https://kong.bintray.com/kuma/kuma-0.2.1-centos-amd64.tar.gz)
* [RedHat](https://kong.bintray.com/kuma/kuma-0.2.1-rhel-amd64.tar.gz)
* [Debian](https://kong.bintray.com/kuma/kuma-0.2.1-debian-amd64.tar.gz)
* [Ubuntu](https://kong.bintray.com/kuma/kuma-0.2.1-ubuntu-amd64.tar.gz)
* [macOS](https://kong.bintray.com/kuma/kuma-0.2.1-darwin-amd64.tar.gz)
...
* We are adding a `kuma.io/mesh: default` annotation to determine on what [`Mesh`](/docs/0.2.1/policies/#mesh) the service belongs.
