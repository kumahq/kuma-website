...
::: tip
The official Docker images are used by default in the [Kubernetes](/docs/1.2.3/installation/kubernetes/) and [OpenShift](/docs/1.2.3/installation/openshift/) distributions.
:::
