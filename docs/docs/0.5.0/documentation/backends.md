...
::: tip
This information has been documented for clarity, but when following the [installation instructions](/install/0.5.0) these settings will be automatically configured.
:::
