...
:::tip
If you wish to use Kuma on Amazon EKS please follow the [Kubernetes instructions](/docs/1.2.2/installation/kubernetes/) instead.
:::
...
or you can [download](https://download.konghq.com/mesh-alpine/kuma-1.2.2-centos-amd64.tar.gz) the distribution manually.
