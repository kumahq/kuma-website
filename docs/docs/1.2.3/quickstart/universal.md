...
With Traffic Metrics we can leverage Prometheus and Grafana to provide powerful dashboards that show the overall traffic activity of the application and the status of the service mesh.
