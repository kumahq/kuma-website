...
or you can [download](https://kong.bintray.com/kuma/kuma-1.0.7-centos-amd64.tar.gz) the distribution manually.
...
In order to start using Kuma, it's time to check out the [quickstart guide for Universal](/docs/1.0.7/quickstart/universal/) deployments.
