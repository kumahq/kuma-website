...
::: tip
The official Docker images are used by default in the [Kubernetes](/docs/1.0.7/installation/kubernetes/) and [OpenShift](/docs/1.0.7/installation/openshift/) distributions.
:::
...
* **kuma-cp**: at `kong-docker-kuma-docker.bintray.io/kuma-cp:1.0.7`
* **kuma-dp**: at `kong-docker-kuma-docker.bintray.io/kuma-dp:1.0.7`
* **kumactl**: at `kong-docker-kuma-docker.bintray.io/kumactl:1.0.7`
* **kuma-prometheus-sd**: at `kong-docker-kuma-docker.bintray.io/kuma-prometheus-sd:1.0.7`
...
$ docker run \
    -p 5681:5681 \
    kong-docker-kuma-docker.bintray.io/kuma-cp:1.0.7 run
```
...
* [CentOS](https://kong.bintray.com/kuma/kuma-1.0.7-centos-amd64.tar.gz)
* [RedHat](https://kong.bintray.com/kuma/kuma-1.0.7-rhel-amd64.tar.gz)
* [Debian](https://kong.bintray.com/kuma/kuma-1.0.7-debian-amd64.tar.gz)
* [Ubuntu](https://kong.bintray.com/kuma/kuma-1.0.7-ubuntu-amd64.tar.gz)
* [macOS](https://kong.bintray.com/kuma/kuma-1.0.7-darwin-amd64.tar.gz)
...
You will then find the `kumactl` executable in the `kuma-1.0.7/bin` folder.
