...
* **Standalone and multi-zone**: Supports multiple clouds, regions, and Kubernetes clusters with native DNS service discovery and ingress capability.
  * [Read more about standalone deployments](/docs/1.0.7/documentation/deployments/#standalone-mode)
  * [Read more about multi-zone deployments](/docs/1.0.7/documentation/deployments/#multi-zone-mode)
