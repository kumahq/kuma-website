...
* **kuma-cp**: at `kong-docker-kuma-docker.bintray.io/kuma-cp:1.0.4`
* **kuma-dp**: at `kong-docker-kuma-docker.bintray.io/kuma-dp:1.0.4`
* **kumactl**: at `kong-docker-kuma-docker.bintray.io/kumactl:1.0.4`
* **kuma-prometheus-sd**: at `kong-docker-kuma-docker.bintray.io/kuma-prometheus-sd:1.0.4`
...
$ docker run \
    -p 5681:5681 \
    kong-docker-kuma-docker.bintray.io/kuma-cp:1.0.4 run
```
...
* [macOS](https://kong.bintray.com/kuma/kuma-1.0.4-darwin-amd64.tar.gz)
...
You will then find the `kumactl` executable in the `kuma-1.0.4/bin` folder.
