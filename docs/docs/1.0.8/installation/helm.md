...
::: tip
Kuma also provides an alternative [Kubernetes distribution](/docs/1.0.8/installation/kubernetes/) that we can use instead of Helm charts.
:::
...
This example will run Kuma in `standalone` mode for a "flat" deployment, but there are more advanced [deployment modes](/docs/1.0.8/documentation/deployments/) like "multi-zone".
