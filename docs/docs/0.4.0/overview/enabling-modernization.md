...
<center>
<img src="/images/docs/0.4.0/diagram-05.jpg" alt="" style=" padding-top: 20px; padding-bottom: 10px;"/>
</center>
...
Unlike other control planes, Kuma is easy to use. Anybody - from any team - can implement Kuma in [three simple steps](/install/0.4.0) across both traditional monolithic applications and modern microservices.
