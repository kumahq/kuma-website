...
or you can [download](https://kong.bintray.com/kuma/kuma-0.4.0-centos-amd64.tar.gz) the distribution manually.
...
Congratulations! You have successfully installed Kuma on CentOS. In order to start using Kuma, it's time to check out the  quickstart guide for Universal deployments.
