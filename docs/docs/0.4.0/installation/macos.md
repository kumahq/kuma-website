...
Congratulations! You have successfully installed Kuma on MacOS. In order to start using Kuma, it's time to check out the  quickstart guide for Universal deployments.
