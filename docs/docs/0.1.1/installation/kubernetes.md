...
* [CentOS](https://kong.bintray.com/kuma/kuma-0.1.1-centos.tar.gz)
* [RedHat](https://kong.bintray.com/kuma/kuma-0.1.1-rhel.tar.gz)
* [Debian](https://kong.bintray.com/kuma/kuma-0.1.1-debian.tar.gz)
* [Ubuntu](https://kong.bintray.com/kuma/kuma-0.1.1-ubuntu.tar.gz)
* [macOS](https://kong.bintray.com/kuma/kuma-0.1.1-darwin.tar.gz)
...
* We are adding a `kuma.io/mesh: default` annotation to determine on what [`Mesh`](/docs/0.1.1/policies/#mesh) the service belongs.
